...
<div class="p-3">
	<h3>${mensaje}</h3>
	<a href="agregarForm" class="btn m-2 btn-outline-secondary">Agregar Producto</a>

	<form method="POST" action="buscar">
		<table>
			<tr>
				<td class="p-2"><label for="producto">Buscar:</label></td>
				<td><input class="form-control" type="text"
					placeholder="Buscar por nombre" name="productoBuscado" /></td>
				<td colspan="2"><input type="submit"
					class="btn m-2  btn-outline-info" value="Buscar" /></td>
			</tr>
		</table>
	</form>
		...
		<thead class="thead-dark">
			...
			<c:forEach items="${VO.productos}" var="producto">
				<tr>
					...
					<td>
						<div>
							<a href="editarForm?id=${producto.getId()}" class="btn btn-outline-success btn-sm">Editar</a> 
							<a href="eliminar?id=${producto.getId()}" class="btn btn-outline-danger btn-sm">Eliminar</a>
						</div>
					</td>
				</tr>
			</c:forEach>
